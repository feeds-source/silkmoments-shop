        ...
        <div className="mx-auto flex h-16 min-w-0 max-w-6xl items-center justify-between gap-2 px-3 sm:px-4">
          ...
          <div className="flex shrink-0 items-center gap-1 sm:gap-2">
            <button
              ...
              className="inline-flex h-11 items-center gap-1.5 rounded-full border border-line px-2.5 text-xs uppercase tracking-wider text-accent transition-colors duration-150 hover:border-accent sm:px-3"
        ...
        {open && (
          <div className="border-t border-accent/20 bg-surface px-4 py-5 md:hidden">
            <div className="flex flex-col gap-1">
              ...
              <button
                type="button"
                className="inline-flex h-11 items-center px-3 text-xs uppercase tracking-[0.2em] text-muted"
                onClick={() => {
                  setOpen(false);
                  setSearchOpen(true);
                }}
