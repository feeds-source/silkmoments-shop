...
function SizeGuide() {
  ...
  return (
    <main>
      <PageHero
        image="/banners/measure-front.jpg"
        kicker="Atelier fittings"
        title="Size charts"
        body="Find a size from the tape, then read the maps — bra heat, body ranges, corset lacing, hose, gowns."
      >
      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        ...
        <section id="bras" className="scroll-mt-32 pt-16">
          ...
          <p className="mt-3 max-w-xl text-pretty text-muted">{CHART_COPY.bra.body}</p>
          <ChartTable
        ...
        <section id="body" className="scroll-mt-32 pt-16">
          ...
          <p className="mt-3 max-w-xl text-pretty text-muted">{CHART_COPY.alpha.body}</p>
          <ChartTable
        ...
        <section id="night" className="scroll-mt-32 pt-16">
          ...
          <p className="mt-3 max-w-xl text-pretty text-muted">{CHART_COPY.nighty.body}</p>
          <NightyChart />
          <ChartTable
        ...
        <section id="gowns" className="scroll-mt-32 pt-16">
          ...
          <p className="mt-3 max-w-xl text-pretty text-muted">{CHART_COPY.gown.body}</p>
          <GownChart />
          <ChartTable
        ...
        <section id="hose" className="scroll-mt-32 pt-16">
          ...
          <p className="mt-3 max-w-xl text-pretty text-muted">Height first, then thigh for the welt. If between, take the larger.</p>
          <HoseChart />
          <ChartTable
        ...
        <section id="swim" className="scroll-mt-32 pt-16">
          ...
          <p className="mt-3 max-w-xl text-pretty text-muted">Triangle tops follow hip for the brief, nearest cup for the top.</p>
          <ChartTable
        ...
        <section id="free" className="scroll-mt-32 pt-16">
          ...
          <p className="mt-3 max-w-xl text-pretty text-muted">{CHART_COPY.free.body}</p>
          <ChartTable
